...
//oneDAL specific helper functionality -- oneDAL is not built in every method
#ifdef ONEDAL_EXPORT
typedef oneapi::dal::v1::feature_type 		DALFeatureType;
typedef oneapi::dal::v1::feature_type::ratio 	DALNumeric; //we will assume all data is ratio as opposed to interval
typedef oneapi::dal::v1::data_type		DALDataType;
typedef oneapi::dal::vi::table_metadata		DALTableMetadata;
typedef oneapi::dal::v1::heterogen_table	DALHeterogenTable;
typedef oneapi::dal::array			DALArray

typedef oneapi::dal::v1::data_type::int8	DAL_Int8;
typedef oneapi::dal::v1::data_type::int16	DAL_Int16;
typedef oneapi::dal::v1::data_type::int32	DAL_Int32;
typedef oneapi::dal::v1::data_type::uint16	DAL_UInt16;
typedef oneapi::dal::v1::data_type::uint32	DAL_UInt32;
typedef oneapi::dal::v1::data_type::float32	DAL_Float32;
typedef oneapi::dal::v1::data_type::foat64	DAL_Float64;

typedef oneapi::dal::array<DAL_Int8>		DALArray_Int8;
typedef oneapi::dal::array<DAL_Int16>		DALArray_Int16;
typedef oneapi::dal::array<DAL_UInt16>		DALArray_UInt16;
typedef oneapi::dal::array<DAL_Int32>		DALArray_Int32;
typedef oneapi::dal::array<DAL_UInt32>		DALArray_UInt32;
typedef oneapi::dal::array<DAL_Float32>		DALArray_Float32;
typedef oneapi::dal::array<DAL_Float64>		DALArray_Float64;

typedef oneapi::dal::array<DAL_Int8>::wrap	CreateDALArray_Int8;
typedef oneapi::dal::array<DAL_Int16>::wrap	CreateDALArray_Int16;
typedef oneapi::dal::array<DAL_UInt16>::wrap	CreateDALArray_UInt16;
typedef oneapi::dal::array<DAL_Int32>::wrap	CreateDALArray_Int32;
typedef oneapi::dal::array<DAL_UInt32>::wrap	CreateDALArray_UInt32;
typedef oneapi::dal::array<DAL_Float32>::wrap	CreateDALArray_Float32;
typedef oneapi::dal::array<DAL_Float64>::wrap	CreateDALArray_Float64;

inline DALDataType GDAL2DAL(GDALDataType type) {
	switch(type) {
		case GDT_Int8: 		return DAL_Int8;
		case GDT_Int16: 	return DAL_Int16;
		case GDT_UInt16:	return DAL_UInt16;
		case GDT_Int32:		return DAL_Int32;
		case GDT_UInt32:	return DAL_UInt32;
		case GDT_Float32:	return DAL_Float32;
		case GDT_Float64:	return DAL_Float64;
		default:		throw std::runtime_error("GDALDataType not supported.");	
	}
}

inline void 
DALTableFill(
	DALHeterogenTable& table,
	std::vector<RasterBandMetaData>& bands,
	int nFeatures
) {
	for (int64_t i = 0; i < static_cast<int64_t>(bands.size()); i++) {
		switch (bands[i].type) {
			case GDT_Int8:
				DALArray_Int8 arr = CreateDALArray_Int8(bands[i].p_buffer, nFeatures);
				table.set_column<DAL_Int8>(i, arr);
				break;
			case GDT_Int16:
				DALArray_Int16 arr = CreatDALArray_Int16(bands[i].p_buffer, nFeatures);
				table.set_column<DAL_Int16>(i, arr);
				break;
			case GDT_UInt16:
				DALArray_UInt16 arr = CreateDALArray_UInt16(bands[i].p_buffer, nFeatures);
				table.set_column<DAL_UInt16>(i, arr);
				break;
			case GDT_Int32:
				DALArray_Int32 arr = CreateDALArray_Int32(bands[i].p_buffer, nFeatures);
				table.set_column<DAL_Int32>(i, arr);
				break;
			case GDT_UInt32:
				DALArray_UInt32 arr = CreateDALArray_UInt32(bands[i].p_buffer, nFeatures);
				table.set_column<DAL_UInt32>(i, arr);
				break;
			case GDT_Float32:
				DALArray_Float32 arr = CreateDALArray_Float32(bands[i].p_buffer, nFeatures);
				table.set_column<DAL_Float32>(i, arr);
				break;
			case GDT_Float64:
				DALArray_Float64 arr = CreateDalArray_Float64(bands[i].p_buffer, nFeatures);
				table.set_column<DAL_Float64>(i, arr);
			default:
				throw std::runtime_error("GDALDataType not support");
		}
	}
}
#endif //ONEDAL_EXPORT
