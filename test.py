...
samples = sgs.sample.systematic(rast, 10000, "square", "centers", access=access, layer_name='RMF_Roads_clip', buff_outer=5000, filename='out/square_centers.shp')
samples = sgs.sample.systematic(rast, 10000, "square", "corners", access=access, layer_name='RMF_Roads_clip', buff_outer=5000, filename='out/square_corners.shp')
samples = sgs.sample.systematic(rast, 10000, "square", "random", access=access, layer_name='RMF_Roads_clip', buff_outer=5000, filename='out/square_random.shp')
samples = sgs.sample.systematic(rast, 10000, "hexagon", "centers", access=access, layer_name='RMF_Roads_clip', buff_outer=5000, filename='out/hexagon_centers.shp')
samples = sgs.sample.systematic(rast, 10000, "hexagon", "corners", access=access, layer_name='RMF_Roads_clip', buff_outer=5000, filename='out/hexagon_corners.shp')
